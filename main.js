...
updateCursorPos = function(e) {
    ...
    cursorpos[0] = (e.clientX * 852 / posOffsetData.width) - parseInt(scrollelems.getAttribute("transform").split("translate(")[1]);
    cursorpos[1] = (e.clientY + window.scrollY) * 480 / posOffsetData.height;
}
clicked = false;
